...
Route::post('do_login', ['uses' => 'AdminController@do_login']);

Route::get('do_logout', ['uses' => 'AdminController@do_logout']);
...
Route::group(['before' => 'auth'], function() {
	...
	*/
	...
	Route::get('kasir/pembayaran_retribusi/dokumen/{id}', ['uses' => 'KasirController@pembayaran_retribusi_dokumen']);
