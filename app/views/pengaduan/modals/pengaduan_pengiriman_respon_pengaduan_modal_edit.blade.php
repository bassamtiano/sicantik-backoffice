                    ...
                    <div class="tab-content" ng-show="tab.edit_data_tab_detail_tindak_lanjut">
                        <div class="tab-content-left">
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    <input type="text" value="@{{ pengiriman_respon_pengaduan_edit_data.c_skpd_tindaklanjut }}" />
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Tanggal</div>
                                <div class="content-form-input">
                                    <input type="date" value="@{{ pengiriman_respon_pengaduan_edit_data.d_tindak_lanjut }}" />
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Tanggal Tindak Lanjut Selesai</div>
                                <div class="content-form-input">
                                    <input type="date" value="@{{ pengiriman_respon_pengaduan_edit_data.d_tindaklanjut_selesai }}" />
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Nama Penanggung Jawab</div>
                                <div class="content-form-input">
                                    <input type="text" value="@{{ pengiriman_respon_pengaduan_edit_data.nama_penanggungjawab }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-content" ng-show="tab.edit_data_tab_respon_pengaduan">
                        <div class="tab-content-left">
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    <textarea class="form-control" rows="4" cols="15" id="balasan" name="balasan" placeholder="Isi Balasan Pengaduan">@{{ pengiriman_respon_pengaduan_edit_data.e_tindak_lanjut }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
