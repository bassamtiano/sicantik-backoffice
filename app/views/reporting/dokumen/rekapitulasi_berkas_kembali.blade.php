			...
			<div class="surat-item">
				...
				<table>
					...
					<tr>
						...
						<th class="c_alasan">Alasan Kembali</th>
						<th class="c_tanggal_kembali">Tanggal Pengembalian</th>
				...
				@foreach( $result as $r )
					...
					<tr>
						...
						<td class="c_tanggal tinjau ">{{ $r->d_survey }}</td>
						...
						<td class="c_alasan">{{ $r->c_pesan }}</td>
						<td class="c_tanggal_kembali">{{ $r->d_ambil_izin }}</td>
