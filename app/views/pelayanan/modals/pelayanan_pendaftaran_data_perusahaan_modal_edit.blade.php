                    ...
                    <div class="tab-content" ng-show="tab.data_awal_tab_data_perusahaan">
                        ...
                        <div class="tab-content-left">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">@{{ data_perusahaan_edit_data.npwp }}</div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Nama Perusahaan</div>
                                <div class="content-form-input"><input type="text" value="@{{ data_perusahaan_edit_data.n_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Telp Perusahaan</div>
                                <div class="content-form-input"><input type="text" value="@{{ data_perusahaan_edit_data.i_telp_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Alamat Perusahaan</div>
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ data_perusahaan_edit_data.a_perusahaan }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content-right">
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    @{{ data_perusahaan_edit_data.perusahaan_propinsi }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Kabupaten</div>
                                <div class="content-form-input">
                                    @{{ data_perusahaan_edit_data.perusahaan_kabupaten }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Kecamatan</div>
                                <div class="content-form-input">
                                    @{{ data_perusahaan_edit_data.perusahaan_kecamatan }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Kelurahan</div>
                                <div class="content-form-input">
                                    @{{ data_perusahaan_edit_data.perusahaan_kelurahan }}
                                </div>
                            </div>
                            <div class="tab-content-form">
