<form id="form_edit" method="post" target="target_edit" action="{{ URL::to('pelayanan/pendaftaran/data_pemohon/edit') }}">
        ...
        <div class="modal-container large">
            ...
            <div class="modal-footer">
                ...
                <div class="modal-footer-right">
                    <input type="submit" value="Edit" class="button-green" ng-click="modal_edit_submit()"/>
