<div class="modal" ng-show={{ $modal_name }}>
                        ...
                        <div class="tab-content-left">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    @{{ data_pemohon_edit_data.id_propinsi_pemohon }}
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    @{{ data_pemohon_edit_data.id_kabupaten_pemohon }}
                                    <select name="source" ng-option="">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    @{{ data_pemohon_edit_data.id_kecamatan_pemohon }}
                                    <select name="source" ng-option="">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    @{{ data_pemohon_edit_data.id_kelurahan_pemohon }}
                                    <select name="source" ng-option="">
    ...
    <iframe id="target_edit" name="target_delete" style="width:100; height:100; visibility:hidden; position:relative; background:#fff;"></iframe>
