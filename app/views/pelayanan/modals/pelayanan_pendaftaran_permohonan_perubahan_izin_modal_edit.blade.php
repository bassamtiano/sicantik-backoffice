            ...
            <div class="body-summary">
                ...
                <div class="body-summary-left">
                    <div class="summary-item">
                        ...
                        <div class="summary-item-value">
                            @{{ perubahan_izin_edit_data.n_perizinan }}
                        </div>
                    </div>
                    <div class="summary-item">
                        <div class="summary-item-label">
                        ...
                        <div class="summary-item-value">
                            @{{ perubahan_izin_edit_data.n_kelompok }}
                        </div>
                    </div>
                    <div class="summary-item">
                        <div class="summary-item-label">
                        ...
                        <div class="summary-item-value">
                            @{{ perubahan_izin_edit_data.pendaftaran_id }}
                        </div>
                    </div>
                </div>
                <div class="body-summary-right">
                    <div class="summary-item">
                        ...
                        <div class="summary-item-value">
                            @{{ perubahan_izin_edit_data.n_permohonan }}
                        </div>
                    </div>
                    <div class="summary-item">
                        <div class="summary-item-label">
                        ...
                        <div class="summary-item-value">
                            <input type="date" value="@{{ perubahan_izin_edit_data.d_perubahan }}" />
                        </div>
                    </div>
                    <div class="summary-item">
                        <div class="summary-item-label">
                        ...
                        <div class="summary-item-value">
                            @{{ perubahan_izin_edit_data.no_surat }}
                        </div>
                    </div>
                    ...
                    <div class="tab-content" ng-show="tab.data_awal_tab_data_pemohon">
                        ...
                        <div class="tab-content-left">
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">@{{ perubahan_izin_edit_data.sumber_identitas }}</div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">ID</div>
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.no_referensi }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Nama Pemohon</div>
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.n_pemohon }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">No Telp / HP</div>
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.telp_pemohon }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Tanggal Survey</div>
                                <div class="content-form-input"><input type="date" value="@{{ perubahan_izin_edit_data.d_survey }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Lokasi Izin</div>
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ perubahan_izin_edit_data.a_izin }}</textarea>
                                </div>
                            </div>
                            <div class="tab-content-form">
                        ...
                        <div class="tab-content-right">
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    @{{ perubahan_izin_edit_data.propinsi_pemohon }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Kabupaten</div>
                                <div class="content-form-input">
                                    @{{ perubahan_izin_edit_data.kabupaten_pemohon }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Kecamatan</div>
                                <div class="content-form-input">
                                    @{{ perubahan_izin_edit_data.kecamatan_pemohon }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Kelurahan</div>
                                <div class="content-form-input">
                                    @{{ perubahan_izin_edit_data.kelurahan_pemohon }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Alamat Pemohon</div>
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ perubahan_izin_edit_data.a_pemohon }}</textarea>
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Alamat Pemohon di Luar Negeri (Isikan jika ada)</div>
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ perubahan_izin_edit_data.a_pemohon_luar }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-content" ng-show="tab.data_awal_tab_data_perusahaan">
                        ...
                        <div class="tab-content-left">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">@{{ perubahan_izin_edit_data.npwp }}</div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Nama Perusahaan</div>
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.nama_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Telp Perusahaan</div>
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.telp_perusahaan }}" /></div>
                            </div>
                        <!--     <div class="tab-content-form">
                                <div class="content-form-label">Fax</div>
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.fax_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Email</div>
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.email_perusahaan }}" /></div>
                            </div> -->
                            <div class="tab-content-form">
                                <div class="content-form-label">Alamat Perusahaan</div>
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ perubahan_izin_edit_data.alamat_perusahaan }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="tab-content-right">
                            <div class="tab-content-form">
                                <div class="content-form-label">Propinsi</div>
                                <div class="content-form-input">
                                    @{{ perubahan_izin_edit_data.propinsi_perusahaan }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Kabupaten</div>
                                <div class="content-form-input">
                                    @{{ perubahan_izin_edit_data.kabupaten_perusahaan }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Kecamatan</div>
                                <div class="content-form-input">
                                    @{{ perubahan_izin_edit_data.kecamatan_perusahaan }}
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Kelurahan</div>
                                <div class="content-form-input">
                                    @{{ perubahan_izin_edit_data.kelurahan_perusahaan }}
                                </div>
                            </div>
                           <div class="tab-content-form">
                                <div class="content-form-label">Jenis Kegiatan</div>
                                <div class="content-form-input">
                                    <select class="form-option" ng-model="kegiatan_id" ng-options="piok.id as piok.n_kegiatan for piok in perubahan_izin_opsi_kegiatan">
                                        <option value=""> @{{ perubahan_izin_opsi_kegiatan.n_kegiatan }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    <select class="form-option" ng-model="investasi_id" ng-options="pioi.id as pioi.n_investasi for pioi in perubahan_izin_opsi_investasi">
                                        <option value=""> @{{ perubahan_izin_opsi_investasi.n_investasi }}</option>
                                    </select>
                                </div>
                            </div> 
                        </div>
                    ...
                    <div class="tab-content" ng-show="tab.data_awal_tab_persyaratan">
                        <div class="tab-content-table">
                            ...
                            <table>
                                ...
                                <tr ng-repeat="syarat in perubahan_izin_edit_data.syarat">
