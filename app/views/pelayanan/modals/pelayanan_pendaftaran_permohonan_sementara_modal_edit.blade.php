                    ...
                    <div class="tab-content" ng-show="tab.data_awal_tab_data_pemohon">
                        ...
                        <div class="tab-content-left">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input"><input type="text" value="@{{ permohonan_sementara_edit_data.no_referensi }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Nama Pemohon</div>
                                <div class="content-form-input"><input type="text" value="@{{ permohonan_sementara_edit_data.n_pemohon }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">No Telp / HP</div>
                                <div class="content-form-input"><input type="text" value="@{{ permohonan_sementara_edit_data.telp_pemohon }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Tanggal Terima Berkas</div>
                                <div class="content-form-input"><input type="date" value="@{{ permohonan_sementara_edit_data.d_terima_berkas }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Tanggal Peninjauan</div>
                                <div class="content-form-input"><input type="date" value="@{{ permohonan_sementara_edit_data.tanggal_peninjauan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Lokasi Izin</div>
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ permohonan_sementara_edit_data.a_izin }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="tab-content-right">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ permohonan_sementara_edit_data.a_pemohon }}</textarea>
                                </div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Alamat Pemohon di Luar Negeri (Isikan jika ada)</div>
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ permohonan_sementara_edit_data.a_pemohon_luar }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-content" ng-show="tab.data_awal_tab_data_perusahaan">
                        ...
                        <div class="tab-content-left">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input"><input type="text" value="@{{ permohonan_sementara_edit_data.nama_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Telp Perusahaan</div>
                                <div class="content-form-input"><input type="text" value="@{{ permohonan_sementara_edit_data.telp_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Fax</div>
                                <div class="content-form-input"><input type="text" value="@{{ permohonan_sementara_edit_data.fax_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Email</div>
                                <div class="content-form-input"><input type="text" value="@{{ permohonan_sementara_edit_data.email_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Jenis Kegiatan</div>
                                <div class="content-form-input"><input type="text" value="@{{ permohonan_sementara_edit_data.n_kegiatan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Jenis Investasi</div>
                                <div class="content-form-input"><input type="text" value="@{{ permohonan_sementara_edit_data.n_investasi }}" /></div>
                            </div>
                        ...
                        <div class="tab-content-right">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ permohonan_sementara_edit_data.a_perusahaan }}</textarea>
                                </div>
                            </div>
                        </div>
