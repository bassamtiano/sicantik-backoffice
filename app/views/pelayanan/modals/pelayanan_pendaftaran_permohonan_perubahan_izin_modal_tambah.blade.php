                    ...
                    <div class="tab-content" ng-show="tab.data_awal_tab_data_perusahaan">
                        ...
                        <div class="tab-content-left">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.i_telp_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.n_kegiatan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Jenis Investasi</div>
                                <div class="content-form-input"><input type="text" value="@{{ perubahan_izin_edit_data.n_investasi }}" /></div>
                            </div>
                        ...
                        <div class="tab-content-right">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ perubahan_izin_edit_data.a_perusahaan }}</textarea>
                                </div>
                            </div>
                        </div>
