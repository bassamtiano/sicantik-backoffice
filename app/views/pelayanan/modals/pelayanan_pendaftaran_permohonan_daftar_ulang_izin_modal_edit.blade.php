                    ...
                    <div class="tab-content" ng-show="tab.data_awal_tab_data_pemohon">
                        ...
                        <div class="tab-content-left">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input"><input type="date" value="@{{ daftar_ulang_izin_edit_data.d_survey }}" /></div>
                            </div>
                            <div class="tab-content-form">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ daftar_ulang_izin_edit_data.keterangan }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-content" ng-show="tab.data_awal_tab_data_perusahaan">
                        ...
                        <div class="tab-content-left">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input"><input type="text" value="@{{ daftar_ulang_izin_edit_data.telp_perusahaan }}" /></div>
                            </div>
                            <div class="tab-content-form">
                                <div class="content-form-label">Alamat Perusahaan</div>
                                <div class="content-form-input">
                                    <textarea rows="4">@{{ daftar_ulang_izin_edit_data.alamat_perusahaan }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content-right">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    <select class="form-option" ng-model="kegiatan_id" ng-options="duiok.id as duiok.n_kegiatan for duiok in daftar_ulang_izin_opsi_kegiatan">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input">
                                    <select class="form-option" ng-model="investasi_id" ng-options="duioi.id as duioi.n_investasi for duioi in daftar_ulang_izin_opsi_investasi">
