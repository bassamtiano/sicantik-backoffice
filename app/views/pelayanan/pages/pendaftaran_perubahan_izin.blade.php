...
@section('angular_controller')
	ng-controller="PelayananPendaftaranPermohonanPerubahanIzinCtrl"
@stop
...
@section('table_content')
	...
	<table role="table-fluid">
		<tr ng-repeat="pppi in pelayanan_pendaftaran_permohonan_perubahan_izin_data | orderBy:predicate:reverse | filter:search | limitTo:displayed">
...
@section('modal-content')
	@include('pelayanan.modals.pelayanan_pendaftaran_permohonan_perubahan_izin_modal_edit', ['modal_name' => 'modal_edit'])
@stop