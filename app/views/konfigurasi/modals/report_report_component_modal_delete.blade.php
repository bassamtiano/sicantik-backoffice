<form id="form_data_awal" method="post" action="{{ URL::to('konfigurasi/report/report_component/delete') }}">
    ...
    <div class="modal-container small">
        ...
        <div class="modal-footer">
            ...
            <div class="modal-footer-right">
                <input type="submit" value="Hapus" class="btn button-red" ng-click="modal_data_awal_submit()"/>
