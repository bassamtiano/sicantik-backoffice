            ...
            <div class="body-tab-wrapper">
                <div class="tab-nav">
                    <ul class="tab-nav-wrapper">
                       <li class="tab-nav-item" id="tab_nav_tambah_kelurahan" ng-click="show_tab('tab.data_awal_tab_persyaratan', 'tab_nav_tambah_kelurahan')">Data Kelurahan</li>
                    <ul>
                </div>
                    ...
                    <div class="tab-content"> 
                        ...
                        <div class="tab-content-left">
                            ...
                            <div class="tab-content-form">
                                ...
                                <div class="content-form-input"><input type="text" name="n_kelurahan" /></div>
                            </div>
