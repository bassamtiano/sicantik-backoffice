<form id="form_ganda" method="post" target="target_ganda" action="{{ URL::to('konfigurasi/report/report_component/ganda') }}">
<!-- <form id="form_ganda" method="post" action="{{ URL::to('konfigurasi/report/report_component/ganda') }}"> -->
...
<div class="modal" ng-show={{ $modal_name }}>
    ...
    <div class="modal-container large">
        <div class="modal-header update">
            <h2>Edit Report Component</h2><a class="button-close" href ng-click="close_modal('modal_ganda')">x</a>
        </div>
